...
export const mojo_to_lotus = (mojo) => {
  return lotus_formatter(Number.parseInt(mojo), 'mojo').to('lotus').value();
};

export const lotus_to_mojo = (lotus) => {
  return lotus_formatter(Number.parseFloat(Number(lotus)), 'lotus')
    .to('mojo')
    .value();
};

export const mojo_to_lotus_string = (mojo) => {
  return lotus_formatter(Number(mojo), 'mojo').to('lotus').toString();
};

export const mojo_to_colouredcoin = (mojo) => {
  return lotus_formatter(Number.parseInt(mojo), 'mojo')
    .to('colouredcoin')
    .value();
};
...
export const mojo_to_colouredcoin_string = (mojo) => {
  return lotus_formatter(Number(mojo), 'mojo').to('colouredcoin').toString();
};
