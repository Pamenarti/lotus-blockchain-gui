...
function BalanceCard(props: BalanceCardProps) {
  ...
  const balance_ptotal_lotus = mojo_to_colouredcoin_string(balance_ptotal);
  const balance_pending_lotus = mojo_to_colouredcoin_string(balance_pending);
  const balance_change_lotus = mojo_to_colouredcoin_string(balance_change);
  const acc_content =
    balancebox_1 +
    balancebox_2 +
    balancebox_ptotal +
